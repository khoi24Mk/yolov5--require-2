...
def run(weights=ROOT / 'runs/train/exp5/weights/best.pt',  # model.pt path(s)
    ...
    return webcam, source, imgsz, stride, pt, model, half, device,\
...
def mainw(x):
    ...
    save_dir, augment, conf_thres, iou_thres, classes, agnostic_nms, \
    max_det, save_crop, line_thickness, names, save_txt, save_conf, \
    save_img, hide_labels, hide_conf, update, weights, visualize, view_img = run(**vars(opt))

    x.initArguments(webcam, source, imgsz, stride, pt, model, half, device, \
    save_dir, augment, conf_thres, iou_thres, classes, agnostic_nms, \
    max_det, save_crop, line_thickness, names, save_txt, save_conf, \
    save_img, hide_labels, hide_conf, update, weights, visualize, view_img)
    # x.startDections()
